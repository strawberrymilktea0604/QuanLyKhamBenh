      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b">
            <h2 className="text-lg font-semibold">Thông tin phòng khám</h2>
          </div>
          <div className="p-6">
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Phòng Khám Đa Khoa"
                />
              </div>
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium">Tự động xác nhận lịch</p>
                  <p className="text-sm text-gray-500">Tự động xác nhận lịch hẹn online</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" className="sr-only peer" />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
